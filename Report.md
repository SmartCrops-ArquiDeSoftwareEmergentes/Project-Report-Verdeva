...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <strong>Litano Liza, Joel Alexander:</strong> Redacté las políticas de source code management (modelo de ramas, convenciones de commits y flujo de PR), junto con plantilla de PR y checklist de calidad. Escribí la estrategia de versionado, calendario de releases y políticas de revisión por pares. Sistematizé entrevistas y su relación con la calidad del código y la entrega continua.
    </td>
    <td>
