...
| **Repository**                                          | **Branch**              | **Archivo .feature / Test**        | **User Story Relacionada(s)** | **Descripción principal**                                                 | **Commit Id**                                | **Commit Message**                       | **Commit Message Body**                                               | **Committed on (Date)** |
| ------------------------------------------------------- | ----------------------- | ---------------------------------- | ----------------------------- | ------------------------------------------------------------------------- | -------------------------------------------- | ---------------------------------------- | --------------------------------------------------------------------- | ----------------------- |
| SmartCrops-ArquiDeSoftwareEmergentes/Back-End-Verdeva   | feature/testing-sprint2 | recover_password.feature           | US-06                         | Pruebas BDD para recuperación de contraseña en la app móvil.              | **9fa3c8be12f44a1e9dc20f45aa71db0c9e51a8c4** | test: add recover password feature       | Added feature file for password recovery flow validation.             | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Api-edge-Verdeva   | feature/testing-sprint2 | chatbot_web.feature                | US-15                         | Pruebas BDD para chatbot de IA en la aplicación web.                      | **c18e72aa4499153b02f16ea81e9b4c032f7f31d1** | test: add chatbot AI web feature         | Added BDD scenarios for AI chatbot conversational flow.               | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Api-edge-Verdeva   | feature/testing-sprint2 | sensors_realtime.feature           | US-16                         | Pruebas BDD e integración para visualización de datos IoT en tiempo real. | **7ad2fe6d3b9bdc448f508114d0c1f9366e914cba** | test: add realtime sensor feature        | Added integration scenarios validating real-time IoT streaming.       | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Api-edge-Verdeva   | feature/testing-sprint2 | sensors_history.feature            | US-18                         | Pruebas BDD para historial de datos de sensores agrícolas.                | **e4c8a7b1c93f10844fb3392b0d55c8f5e0d2c6ea** | test: add sensor history feature         | Added feature file validating historical sensor data queries.         | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Mobile-App-Verdeva | feature/testing-sprint2 | push_notifications.feature         | US-19                         | Pruebas BDD para sistema de notificaciones push en app móvil.             | **ab573cd0f31a584691bd9012e0ce44e1a085b7f9** | test: add push notification feature      | Added feature file for mobile push alert triggers.                    | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/AI-API             | feature/testing-sprint2 | predictive_reports.feature         | US-20                         | Pruebas BDD para generación de reportes y análisis predictivos.           | **d87e1a3c9472ef0a4b6d9f21f0b3ac14cd23b901** | test: add predictive reports feature     | Added feature file for predictive analytics API validation.           | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/AI-API             | feature/testing-sprint2 | recommendations_mobile.feature     | US-21                         | Pruebas BDD para recomendaciones personalizadas móviles.                  | **fe210abf772be84439cd70e913c1bd99b0e5f772** | test: add mobile recommendations feature | Added feature scenarios for mobile personalized crop suggestions.     | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Api-edge-Verdeva   | feature/testing-sprint2 | auth_security.feature              | TS-02                         | Pruebas BDD de autenticación segura.                                      | **1bd04487af0c55c94e5a78b2ce61384a943ea273** | test: add authentication security tests  | Added BDD tests for authentication error handling and security rules. | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Api-edge-Verdeva   | feature/testing-sprint2 | iot_integration.feature            | TS-03                         | Pruebas de integración con dispositivos IoT.                              | **83f4be6e0a7cd59e1db811d33cd78aa93fdcd2fb** | test: add IoT integration tests          | Added integration tests for IoT device data pipelines.                | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/AI-API             | feature/testing-sprint2 | alerts_engine.feature              | TS-04                         | Pruebas para motor de alertas IA + sensores.                              | **b944d7ef02ac19b14d5dd21efc27909d1efc6ac1** | test: add alerts engine feature          | Added IA-driven alert engine BDD test cases.                          | **02/12/2025**          |
| SmartCrops-ArquiDeSoftwareEmergentes/Back-End-Verdeva   | feature/testing-sprint2 | crud_fields_crops_extended.feature | TS-05                         | Pruebas BDD extendidas para CRUD de campos y cultivos.                    | **6ae731d8c4b2ff2940f952103111deefc3d9b246** | test: extend CRUD fields and crops tests | Added extended CRUD tests including advanced validations.             | **02/12/2025**          |
